function output = antialiasedFLmodelSingle(phase_i, A, B, C, R, F, D, fs, mean_fO)
% generate single cycle of Fujisaki-Ljungqvist glottal source model with
% anti-aliasing in the continuous time domain.
% output = antialiasedFLmodelSingle(phase_i, A, B, C, R, F, D, fs, mean_fO)
%
% Input argument
...
% 26/Sept./2017 fixed bug. by Hideki Kawahara
